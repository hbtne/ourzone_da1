          ...
          > */}
            <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center' }}>
              ...
              <View style={styles.section}>
                ...
                <TouchableOpacity style={styles.option} onPress={() => navigation.navigate('ChangeInfoStack', { screen: 'ChangeMail' })}>
                <SvgXml style={styles.icon3} xml={mailIcon}/>
                  <Text style={styles.optionText}>Change email address</Text>
                  <SvgXml style={styles.iconNext} xml={nextIcon}/>
                </TouchableOpacity>
                <TouchableOpacity style={styles.option}  onPress={() => navigation.navigate('ChangeInfoStack', { screen: 'ChangePass' })}>
